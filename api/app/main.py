...
# Configuration CORS
# En production, restreindre aux origines autorisees.
# En developpement, localhost:5173 (Vite), localhost:8501 (dashboard), localhost:3000 (Grafana)
import os

_allowed_origins = [
    o.strip() for o in os.getenv(
        "CORS_ORIGINS",
        "http://localhost:5173,http://localhost:8501,http://localhost:3000,http://127.0.0.1:5173,http://127.0.0.1:8501"
    ).split(",") if o.strip()
]
...
app.include_router(aviation_stats.router, prefix="/aviationStats", tags=["Aviation"])
